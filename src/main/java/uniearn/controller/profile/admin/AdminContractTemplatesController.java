...
public class AdminContractTemplatesController {
    ...
    private VBox createTemplateCard(ContractTemplate template) {
        ...
        previewBtn.setStyle("-fx-padding: 8 15; -fx-font-size: 12; -fx-background-color: #3182ce; -fx-text-fill: white;");
        previewBtn.setOnAction(e -> previewTemplate(template));

        Button editBtn = new Button("✏ Éditer");
        editBtn.setStyle("-fx-padding: 8 15; -fx-font-size: 12; -fx-background-color: #2d5a4d; -fx-text-fill: white;");
        editBtn.setOnAction(e -> showEditTemplateDialog(template));

        Button deleteBtn = new Button("🗑 Supprimer");
        deleteBtn.setStyle("-fx-padding: 8 15; -fx-font-size: 12; -fx-background-color: #c53030; -fx-text-fill: white;");
    ...
    private void showCreateTemplateDialog() {
        ...
        VBox header = new VBox(5);
        header.setStyle("-fx-background-color: #4CAF50; -fx-padding: 20px;");
    ...
    private void showEditTemplateDialog(ContractTemplate template) {
        ...
        VBox header = new VBox(5);
        header.setStyle("-fx-background-color: #2d5a4d; -fx-padding: 20px;");
