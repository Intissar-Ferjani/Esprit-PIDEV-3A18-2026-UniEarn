...
/**
 * Contrôleur pour la gestion des moyens de paiement (comptes bancaires) de l'admin
 */
public class AdminPaymentMethodsController {
    ...
    /**
     * Charger les comptes bancaires de l'admin
     */
    ...
    private VBox createAccountCard(BankAccount account) {
        ...
        if (account.isDefault()) {
            ...
            defaultLabel.setStyle("-fx-background-color: #2196F3; -fx-text-fill: white; -fx-padding: 2 8; -fx-border-radius: 3;");
