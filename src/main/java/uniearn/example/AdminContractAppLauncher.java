...
/**
 * Launcher pour lancer AdminContractApp avec les bonnes options JavaFX
 * Cette classe contourne le problème des options VM manquantes
 */
public class AdminContractAppLauncher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AdminContractApp.launch(AdminContractApp.class, args);
        } catch (Exception e) {
