...
public class Application {
    ...
    public double getProposedBudget() { return proposedBudget; }   // NEW
    public void setProposedBudget(double proposedBudget) { this.proposedBudget = proposedBudget; }

    public int getEstimatedDuration() { return estimatedDuration; } // NEW
    ...
    public boolean isValid() {
        return coverLetter != null && !coverLetter.trim().isEmpty() && coverLetter.length() >= 50
                && proposedBudget > 0 && estimatedDuration > 0;
    }

    @Override
    public boolean equals(Object o) { return o instanceof Application && ((Application)o).idApplication == this.idApplication; }

    @Override
    public int hashCode() { return Objects.hash(idApplication); }
